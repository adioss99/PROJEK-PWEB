                        ...
                        <form action="" method="post">
                            <div class="card-body p-5">
                                ...
                                <div class="form-outline mb-3">
                                    ...
                                    <input type="email" id="typeEmailX-2" name="email" class="form-control form-control-lg" style="border-color: #06283D;"required/>
                                </div>
                                <div class="form-outline mb-3">
                                    <label class="form-label" for="typePasswordX-2">Password</label>
                                    <input type="password" id="typePasswordX-2" name="password" class="form-control form-control-lg" style="border-color: #06283D;"required/>
                                </div>
                                <?php if(isset($error)):?>
                                    <p style="color: red; font-style: italic">Email dan password salah</p>
                                <?php endif;?>
